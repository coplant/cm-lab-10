...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.abcTable = QTableWidget(self.centralwidget)
        self.abcTable.setObjectName(u"abcTable")
        self.abcTable.setGeometry(QRect(380, 10, 201, 171))
        self.abcTable.setMinimumSize(QSize(191, 171))
        self.abcTable.setMaximumSize(QSize(211, 171))
        self.abcTable.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.abcTable.setHorizontalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.abcTable.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContents)
        self.abcTable.setGridStyle(Qt.SolidLine)
        self.abcTable.setColumnCount(0)
        self.abcTable.horizontalHeader().setVisible(False)
        self.abcTable.verticalHeader().setVisible(False)
